defmodule Syncthex.Proto.PbExtension do
  ...
  extend Google.Protobuf.EnumOptions, :enumdecl, 62024, optional: true, type: :bool
  ...
  extend Google.Protobuf.FileOptions, :typedecl_all, 63030, optional: true, type: :bool
  extend Google.Protobuf.FileOptions, :enumdecl_all, 63031, optional: true, type: :bool
  extend Google.Protobuf.FileOptions, :goproto_registration, 63032, optional: true, type: :bool
  extend Google.Protobuf.FileOptions, :messagename_all, 63033, optional: true, type: :bool
  extend Google.Protobuf.FileOptions, :goproto_sizecache_all, 63034, optional: true, type: :bool
  extend Google.Protobuf.FileOptions, :goproto_unkeyed_all, 63035, optional: true, type: :bool
  ...
  extend Google.Protobuf.MessageOptions, :typedecl, 64030, optional: true, type: :bool
  extend Google.Protobuf.MessageOptions, :messagename, 64033, optional: true, type: :bool
  extend Google.Protobuf.MessageOptions, :goproto_sizecache, 64034, optional: true, type: :bool
  extend Google.Protobuf.MessageOptions, :goproto_unkeyed, 64035, optional: true, type: :bool
  ...
  extend Google.Protobuf.FieldOptions, :wktpointer, 65012, optional: true, type: :bool
end
